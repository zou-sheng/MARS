...
python main.py --optim_obj EDP --population 20 --epochs 100  --accelerator Gemmini --mapper Saturn --type arch --version v1 --workload unet --layer_id 0 --batch_size 1 --expanded_scope 0.2 --all_DNN
cd ..