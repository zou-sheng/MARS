...
total_compute = 6 * (matrix[1][0] + matrix[1][1] + matrix[1][2] + matrix[1][3] + matrix[1][4] + matrix[1][5] + matrix[1][6] + matrix[1][7]) + \
4 * (matrix[3][0] + matrix[3][1] + matrix[3][2] + matrix[3][3] + matrix[3][4] + matrix[3][5] + matrix[3][6] + matrix[3][7]) + \
5 * (matrix[0][0] + matrix[0][1] + matrix[0][2] + matrix[0][3] + matrix[0][4] + matrix[0][5] + matrix[0][6] + matrix[0][7]) + \
3 * (matrix[2][0] + matrix[2][1] + matrix[2][2] + matrix[2][3] + matrix[2][4] + matrix[2][5] + matrix[2][6] + matrix[2][7]) + \
2 * (matrix[4][0] + matrix[4][1] + matrix[4][2] + matrix[4][3] + matrix[4][4] + matrix[4][5] + matrix[4][6] + matrix[4][7]) + \
1 * (matrix[5][0] + matrix[5][1] + matrix[5][2] + matrix[5][3] + matrix[5][4] + matrix[5][5] + matrix[5][6] + matrix[5][7])
...
# LRF, 存储容量1, 保存input，input涉及R, S, P, Q, C, H, N
prob += matrix[0][0] + matrix[0][1] + matrix[0][2] + matrix[0][3] + matrix[0][4] + matrix[0][6] + matrix[0][7] == math.log2(1)

# RF, 存储容量2048，保存output, output涉及P, Q, K, H, N并且需要乘上前面所有级的值, spatial跟temporal一样处理
prob += matrix[0][2] + matrix[0][3] + matrix[0][5] + matrix[0][6] + matrix[0][7] + \
matrix[1][2] + matrix[1][3] + matrix[1][5] + matrix[1][6] + matrix[1][7] + \
matrix[2][2] + matrix[2][3] + matrix[2][5] + matrix[2][6] + matrix[2][7] <= math.log2(2048)

# SMEM, 存储容量262144，保存input和wight, spatial跟temporal一样处理
...
matrix[3][0] + matrix[3][1] + matrix[3][4] + matrix[3][5] + matrix[3][6] + \
matrix[4][0] + matrix[4][1] + matrix[4][4] + matrix[4][5] + matrix[4][6] + \
...
matrix[4][0] + matrix[4][1] + matrix[4][2] + matrix[4][3] + matrix[4][4] + matrix[4][6] + matrix[4][7] <= 2*math.log2(262144/2)
...
matrix[3][0] + matrix[3][1] + matrix[3][2] + matrix[3][3] + matrix[3][4] + matrix[3][5] + matrix[3][6] + matrix[3][7] <= math.log2(1024)

# RF并行容量256
prob += matrix[1][0] + matrix[1][1] + matrix[1][2] + matrix[1][3] + matrix[1][4] + matrix[1][5] + matrix[1][6] + matrix[1][7] <= math.log2(256)

# SMEM并行容量4
prob += matrix[3][0] + matrix[3][1] + matrix[3][2] + matrix[3][3] + matrix[3][4] + matrix[3][5] + matrix[3][6] + matrix[3][7] <= math.log2(4)
