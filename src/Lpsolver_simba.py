...
prob += matrix[0][0] + matrix[0][1] + matrix[0][4] + matrix[0][5] + matrix[0][6] == 0 
...
matrix[4][0] + matrix[4][1] + matrix[4][2] + matrix[4][3] + matrix[4][4] + matrix[4][6] + matrix[4][7] <= math.log2(8192)
...
matrix[6][0] + matrix[6][1] + matrix[6][2] + matrix[6][3] + matrix[6][4] + matrix[6][6] + matrix[6][7] <= 2*math.log2(65536/2)   # 这个等式不严谨，放松了，但没想到更好的办法
...
matrix[5][0] + matrix[5][1] + matrix[5][2] + matrix[5][3] + matrix[5][4] + matrix[5][5] + matrix[5][6] + matrix[5][7] <= math.log2(1024)
