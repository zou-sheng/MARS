...
# for layer_id in {5..5}
# do
#     python main.py --optim_obj latency --population 100 --epochs 10 --accelerator Simba --mapper MARS --type arch --version v1 --workload bertlarge --layer_id $layer_id --batch_size 1 --expanded_scope 0.1
# done
...
for layer_id in {1..1}
do
    python main.py --optim_obj latency --population 50 --epochs 50 --accelerator Simba_cosa --mapper MARS --type arch --version v1 --workload alexnet --layer_id $layer_id --batch_size 1 --expanded_scope 0.1
done
# for layer_id in {0..5}
# do
#     python main.py --optim_obj latency --population 50 --epochs 50 --accelerator Simba_cosa --mapper MARS --type arch --version v1 --workload bertlarge --layer_id $layer_id --batch_size 1 --expanded_scope 0.1
# done
cd ..