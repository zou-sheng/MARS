...
# do
#     printf "网络: deepbench, 层数: %d\n" $layer_id 
#     python main.py --optim_obj EDP --population 80 --epochs 80 --accelerator Simba --mapper MARS --type arch --version v1 --workload deepbench --layer_id $layer_id --batch_size 1 --expanded_scope 0.1
# done
# end_time=$(date +%s.%N)    # 获取结束时间
# elapsed_time=$(echo "scale=3; $end_time - $start_time" | bc)  # 计算差值，保留3位小数（秒）
...
do
    ...
    python main.py --optim_obj energy --population 50 --epochs 50 --accelerator Simba --mapper MARS --type arch --version v1 --workload unet --layer_id $layer_id --batch_size 1 --expanded_scope 0.1
...
do
    ...
    python main.py --optim_obj EDP --population 50 --epochs 50 --accelerator Simba --mapper MARS --type arch --version v1 --workload resnet50 --layer_id $layer_id --batch_size 1 --expanded_scope 0.1
...
do
    ...
    python main.py --optim_obj EDP --population 50 --epochs 50 --accelerator Simba --mapper MARS --type arch --version v1 --workload alexnet --layer_id $layer_id --batch_size 1 --expanded_scope 0.1
